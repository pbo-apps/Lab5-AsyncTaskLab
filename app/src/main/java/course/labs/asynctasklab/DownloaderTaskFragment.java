...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Integer[] arrayFriendResIDs = friendResIDs.toArray(new Integer[friendResIDs.size()]);
		downloader.execute(arrayFriendResIDs);
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]>	{
		...
		protected String[] doInBackground(Integer[] friendResIDs) {
			String[] tweets = downloadTweets(friendResIDs);
			return tweets;
		}
